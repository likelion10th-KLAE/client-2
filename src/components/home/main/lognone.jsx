	...
	*/
	...
	return (
		<div>
			...
			<Text2>키우고 있는 식물이 없다면 맞춤형 식물 추천을 받아보세요.</Text2>
			<Link to="/recommend">
				<Recommendbtn>식물 추천 받기</Recommendbtn>
			</Link>
			<Text3>이미 기르고 있는 식물이 있다면 KLAE에 등록하세요.</Text3>
			<Link to="/plant/addplant/createplant">
				<Registerbtn>식물 등록 하기</Registerbtn>
			</Link>
		</div>
	);
};
